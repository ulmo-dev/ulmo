...
twdb_fts_test_sets = [
    ...
    },
    {
        ...
        'return_value': [
            ['2018-02-06 13:00:00', 13.0, 217.66],
            ['2018-02-06 12:00:00', pd.np.nan, 217.66],
            ['2018-02-06 11:00:00', pd.np.nan, 217.64],
            ['2018-02-06 10:00:00', pd.np.nan, 217.60],
            ['2018-02-06 09:00:00', pd.np.nan, 217.56],
            ['2018-02-06 08:00:00', pd.np.nan, 217.51],
            ['2018-02-06 07:00:00', pd.np.nan, 217.45],
            ['2018-02-06 06:00:00', pd.np.nan, 217.40],
            ['2018-02-06 05:00:00', pd.np.nan, 217.38],
            ['2018-02-06 04:00:00', pd.np.nan, 217.39],
            ['2018-02-06 03:00:00', pd.np.nan, 217.41],
            ['2018-02-06 02:00:00', pd.np.nan, 217.47],
        ]
    },
]
