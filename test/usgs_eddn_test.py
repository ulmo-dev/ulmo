...
twdb_stevens_test_sets = [
    {
        ...
        'return_value': [
            ['2013-10-30 04:00:00', pd.np.nan, 194.33],
            ['2013-10-30 05:00:00', pd.np.nan, 195.00],
            ['2013-10-30 06:00:00', pd.np.nan, 200.98],
            ['2013-10-30 07:00:00', pd.np.nan, 200.51],
            ['2013-10-30 08:00:00', pd.np.nan, 199.62],
            ['2013-10-30 09:00:00', pd.np.nan, 193.37],
            ['2013-10-30 10:00:00', pd.np.nan, 193.43],
            ['2013-10-30 11:00:00', pd.np.nan, 193.49],
            ['2013-10-30 12:00:00', pd.np.nan, 193.54],
            ['2013-10-30 13:00:00', pd.np.nan, 193.62],
            ['2013-10-30 14:00:00', pd.np.nan, 193.70],
            ['2013-10-30 15:00:00', 11.9, 193.76],
        ],
    },
    {
        'message_timestamp_utc': datetime(2013,10,30,15,28,18),
        ...
        'return_value': [
            ['2013-10-30 04:00:00', '5', '28', pd.np.nan, 304.71],
            ['2013-10-30 05:00:00', '5', '28', pd.np.nan, 304.63],
            ['2013-10-30 06:00:00', '5', '28', pd.np.nan, 304.63],
            ['2013-10-30 07:00:00', '5', '28', pd.np.nan, 304.63],
            ...
            ['2013-10-30 12:00:00', '5', '28', pd.np.nan, 304.56],
            ['2013-10-30 13:00:00', '5', '28', pd.np.nan, 304.63],
            ['2013-10-30 14:00:00', '5', '28', pd.np.nan, 304.63],
            ['2013-10-30 15:00:00', '5', '28', 12.6, 304.63],
            ['2013-10-30 04:00:00', '6', '28', pd.np.nan, 310.59],
            ['2013-10-30 05:00:00', '6', '28', pd.np.nan, 310.66],
            ['2013-10-30 06:00:00', '6', '28', pd.np.nan, 310.51],
            ['2013-10-30 07:00:00', '6', '28', pd.np.nan, 310.66],
            ...
            ['2013-10-30 12:00:00', '6', '28', pd.np.nan, 310.51],
            ['2013-10-30 13:00:00', '6', '28', pd.np.nan, 310.59],
            ['2013-10-30 14:00:00', '6', '28', pd.np.nan, 310.66],
            ['2013-10-30 15:00:00', '6', '28', 12.6, 310.51],
        ]
    },
    {
        'message_timestamp_utc': datetime(2013,10,30,15,28,18),
...
twdb_texuni_test_sets = [
    {
        ...
        'return_value': [
            ['2013-10-29 16:00:00', pd.np.nan, 110.1],
            ['2013-10-29 17:00:00', pd.np.nan, 110.1],
            ['2013-10-29 18:00:00', pd.np.nan, 110.1],
            ['2013-10-29 19:00:00', pd.np.nan, 110.1],
            ['2013-10-29 20:00:00', pd.np.nan, 110.1],
            ['2013-10-29 21:00:00', pd.np.nan, 110.0],
            ['2013-10-29 22:00:00', pd.np.nan, 110.0],
            ['2013-10-29 23:00:00', pd.np.nan, 110.0],
            ['2013-10-30 00:00:00', pd.np.nan, 109.9],
            ['2013-10-30 01:00:00', pd.np.nan, 109.9],
            ['2013-10-30 02:00:00', pd.np.nan, 109.9],
            ['2013-10-30 03:00:00', pd.np.nan, 109.9],
            ['2013-10-30 04:00:00', pd.np.nan, 110.0],
            ['2013-10-30 05:00:00', pd.np.nan, 110.0],
            ['2013-10-30 06:00:00', pd.np.nan, 109.9],
            ['2013-10-30 07:00:00', pd.np.nan, 109.9],
            ['2013-10-30 08:00:00', pd.np.nan, 109.9],
            ['2013-10-30 09:00:00', pd.np.nan, 109.9],
            ['2013-10-30 10:00:00', pd.np.nan, 109.9],
            ['2013-10-30 11:00:00', pd.np.nan, 109.8],
            ['2013-10-30 12:00:00', pd.np.nan, 109.8],
            ['2013-10-30 13:00:00', pd.np.nan, 109.8],
            ['2013-10-30 14:00:00', pd.np.nan, 109.8],
            ['2013-10-30 15:00:00', pd.np.nan, 109.8],
        ]
    },
]
