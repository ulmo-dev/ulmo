...
twdb_fts_test_sets = [
    {
        ...
        'return_value': [
            ['2018-02-06 02:00:00', pd.np.nan, 72.90],
            ['2018-02-06 03:00:00', pd.np.nan, 72.88],
            ['2018-02-06 04:00:00', pd.np.nan, 72.87],
            ['2018-02-06 05:00:00', pd.np.nan, 72.87],
            ['2018-02-06 06:00:00', pd.np.nan, 72.87],
            ['2018-02-06 07:00:00', pd.np.nan, 72.87],
            ['2018-02-06 08:00:00', pd.np.nan, 72.88],
            ['2018-02-06 09:00:00', pd.np.nan, 72.88],
            ['2018-02-06 10:00:00', pd.np.nan, 72.87],
            ['2018-02-06 11:00:00', pd.np.nan, 72.87],
            ['2018-02-06 12:00:00', pd.np.nan, 72.87],
            ['2018-02-06 13:00:00', pd.np.nan, 72.85],
        ]
    },
]
