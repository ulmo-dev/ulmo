...
def test_get_site_data_multiple_methods():
    ...
    with test_util.mocked_urls(site_data_file):
        # site_data = ulmo.usgs.nwis.get_site_data(site_code, methods={'00062\n:00011': 'all'})
        site_data = ulmo.usgs.nwis.get_site_data(site_code, parameter_code='00062', methods='all')
        assert len(site_data['00062\n:00011:1']['values']) == 288
