...
def test_core_get_values_waterml_1_1():
    ...
    assert values['methods'] == {'2': {'code': '2', 'description': '6" Glass Thermometer, Centigrade Scale', 'id': '2'}}
    assert values['sources'] == {
        '1': {
            'id': '1', 
            'code': '1', 
...
def test_core_get_variable_info_waterml_single_1_1():
    ...
    assert variable_info == {'value_type': 'Sample', 'data_type': 'Sporadic', 'general_category': 'Water Quality', 'sample_medium': 'Surface Water', 'no_data_value': '-9999', 'speciation': 'Not Applicable', 'code': 'Temp', 'id': '3', 'name': 'Temperature', 'vocabulary': 'ipswich', 'time': {'is_regular': True, 'interval': '0', 'units': {'abbreviation': 'month', 'code': '106', 'name': 'month', 'type': 'Time'}}, 'units': {'abbreviation': 'degC', 'code': '96', 'name': 'degree celsius', 'type': 'Temperature'}}
