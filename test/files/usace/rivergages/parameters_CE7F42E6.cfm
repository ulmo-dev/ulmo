...
<select name="fld_parameter" id="fld_parameter">
  <option value="" selected >-----</option>
    ...
    <option value="HP" >Pool Level (Ft)</option>
...
<tr bgcolor="000055">
  <td bgcolor="000055" class="style11"><div align="center"><font size="2"><font color="FFFFFF">Levels Are Between<br>
            ...
            <input name="fld_from" type="text" id="fld_from" value="" size="4" maxlength="7">
And <font size="2">
<input name="fld_to" type="text" id="fld_to" value="" size="4" maxlength="7">
</font></font></font><br>
  </div></td>
</tr>
<tr bgcolor="000055">
<td bgcolor="000055" class="style11"> <div align="center"><font size="2"><font color="FFFFFF">Dates Are Between<br>
          <input name="fld_fromdate" type="text" id="fld_fromdate" value="" size="10" maxlength="10" onBlur="validateDate(document.frm_mining.fld_fromdate);">
          <!--
CF_CAL Custom Tag
...
<a href="javascript:openCalWin_fld_fromdate()"><img src="/WaterControl/images/cal.gif" border=0></a>
 ...
 And
 <input name="fld_todate" type="text" id="fld_todate" value="" size="10" maxlength="10" onBlur="validateDate(document.frm_mining.fld_todate);">
 <!--
CF_CAL Custom Tag
